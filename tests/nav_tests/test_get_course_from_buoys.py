...
from src.tracking.object_dtypes import buoy_array_dtype
...
class BuoySortTests(unittest.TestCase):
    ...
    def test_get_course_from_buoys(self):
        # make buoy arrays
        test_arr_1 = np.array([(80, 60), (50, 3), (100, 135), (60, 177)], dtype=buoy_array_dtype)     # tests standard, 4 buoys, CCW navigation w/ boat outside of bounding box -- example of endurance race
        return_arr_1 = np.array([(50, 3), (80, 60), (100, 135), (60, 177)], dtype=buoy_array_dtype)
