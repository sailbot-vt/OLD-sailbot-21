...
class Rudder:
    ...
    def turn_to(self, rudder_angle):
        ...
        pub.sendMessage("turn rudder to", rudder_ang=(self.rudder_angle_to_servo_angle(constrained_rudder_angle)))
    ...
    def change_rudder_angle(self, delta_rudder_angle):
        ...
        """
        self.turn_to(self.current_rudder_angle + delta_rudder_angle)
